...
وظیفه شما:
یک خلاصه کوتاه، دقیق، جذاب و روان به زبان فارسی بسازید.

قوانین مهم:
۱. خلاصه باید نهایتاً ۴ خط باشد — حدود ۱۲۰ تا ۱۸۰ کاراکتر.
۲. خودتان خلاصه را کوتاه بنویسید — جمله کامل بسازید، وسط جمله قطع نکنید.
۳. ۲ یا ۳ جمله کافی است.
۴. فعالیت، ارزش پیشنهادی و تفاوت سایت را بگو.
۵. لحن خودمونی (محاوره نرم، مناسب داخل محصول): فعل‌های گفتاری — میشه، می‌تونید، داره، می‌سازه، کمک می‌کنه، می‌تونید باهاش؛ مخاطب «شما». «است / می‌شود / می‌باشد / فعالیت دارد» ممنوع.
۶. نیم‌فاصله را رعایت کن (می‌تونید، نمی‌شه، بچه‌ها) و ارقام فارسی بگذار.
۷. کلیشه‌های ماشینی ممنوع: «در دنیای امروز»، لیست سه‌تایی (سریع، آسان و مطمئن)، «نه تنها … بلکه»، پایان‌بندی «امیدوارم مفید بوده باشه».
۸. مثال لحن درست: «با وایب‌فارسی می‌تونید کامپوننت‌های راست‌چین آماده برای React بردارید؛ فونت و تقویم شمسی هم همراهشه.» — به‌جای «این وب‌سایت در حوزه … فعالیت دارد».
